...
/**
 * Homework 3 model class. Stores a collection of circles.
 * 
...
public class HW3Model {
	 ...
	 */
	public ObservableList<HW3Circle> drawDataProperty() {
		return drawData;
	}
	 ...
	 * 
	 * @param s The string (a comma-separated list of six values:
	 *          <code>x, y, radius, red, green, blue</code>).
	 */
	public void add(String s) {
		add(new HW3Circle(s.split("[ ]*,[ ]*")));
	}
	...
	/**
	 * Gets the index of the given circle in the draw list.
	 * 
	 * @param c The circle to find.
	 * @return The index of the given circle.
	 */
	public int getIndex(HW3Circle c) {
		int index = 0;
		for (HW3Circle o : drawData) {
			if (c == o) { return index; }
			index++;
	...
	/**
	 * Homework 3 circle class. Stores circle data.
	 * 
	 * Code was adapted from homework 2 solution.
	 * 
	 * @author Elmer Landaverde
	...
	public class HW3Circle {
		...
		/**
		 * Creates an instance of <code>HW3Circle</code> class with the default
		 * values:
		 * <ul>
		 ...
		 */
		public HW3Circle(double x, double y) {
			this(x, y, RADIUS_DEFAULT, Color.BLACK);
		}

		/**
		 * Creates an instance of <code>HW3Circle</code> class.
		 * 
		 * @param t The string (a comma-separated list of six numeric values:
		 *          <code>x, y, radius, red, green, blue</code>).
		 * @throws NumberFormatException One (or more) values is not numeric.
		 * @throws ArrayIndexOutOfBoundsException Less than six values in the
		 *           string.
		 */
		public HW3Circle(String[] t) throws NumberFormatException,
				ArrayIndexOutOfBoundsException {
			this(Double.parseDouble(t[0]), Double.parseDouble(t[1]), Double
					.parseDouble(t[2]), new Color(Double.parseDouble(t[3]),
					Double.parseDouble(t[4]), Double.parseDouble(t[5]), 1));
		}
		 ...
		 * @param c The circle.
		 */
		public HW3Circle(HW3Circle c) {
			this(c.getCenterX(), c.getCenterY(), c.getRadius(), c.getColor());
		}
		...
		public void setCenterX(double x) {
			centerX.set(clamp(x, X_MIN, X_MAX));
		}
		...
		public void setCenterY(double y) {
			centerY.set(clamp(y, Y_MIN, Y_MAX));
		}
		...
		public boolean contains(double x, double y) {
			return (Math.pow(x - centerX.get(), 2) + Math.pow(y - centerY.get(), 2)) <= Math
					.pow(radius.get(), 2);
		}
