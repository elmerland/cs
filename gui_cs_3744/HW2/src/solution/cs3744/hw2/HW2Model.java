...
/**
 * Homework 2 model class. Stores a collection of circles.
 * 
...
public class HW2Model {
	 ...
	 */
	public ObservableList<HW2Circle> drawDataProperty() {
		return drawData;
	}
	...
	/**
	 * Homework 2 circle class. Stores circle data.
	 * 
	 * @author Denis Gracanin
	 * @version 1
	 */
	public class HW2Circle {
		...
		/**
		 * Creates an instance of <code>HW2Circle</code> class with the default
		 * values:
		 * <ul>
		 ...
		 */
		public HW2Circle(double x, double y) {
		 ...
		 *           string.
		 */
		public HW2Circle(String[] t) throws NumberFormatException,
