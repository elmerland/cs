...
/**
 * Project 1 for CS 3114, fall 2013. This is the main class for the earthquake
...
public class EqSimple
{
    ...
    /**
     * Flag used to determine if the --all option selected
     */
     ...
     *             Exception geenrated by the WatcherService.
     * @throws IOException
        ...
        WatcherParseException
    {
        ...
        while (StreamReader.hasMoreWatcherCommands())
        {
            //System.out.println("Start");
            // Get the watcher commands and process them.
            ArrayList<String> cmds = StreamReader.getWatcherData(watchersFile);
            StreamParser.parseWatcherCmds(cmds);

            // Get the earthquake report and process them.
            Report report =
                StreamReader.getEarthquakeData(offLineFlag, earthquakesFile);
            StreamParser.parseEarthquakeReport(report);
        ...
        StreamReader.resetWatcherHasMoreCommands();
    }
    ...
    /**
     * Returns the value of the allFlag.
     *
     * @return The allFlag.
     */
    ...
    private static boolean validateInputs(String[] args)
    {
        ...
        {
            System.out.println("Invalid arguments! Null or invlaid length.");
            return false;
        }
        // Validate --all flag.
        int watcherIndex;
        ...
        if (!validateWatcherParameter(args[watcherIndex]))
        {
            return false;
        }
        // Validate earthquake stream
        return validateEarthquakeParameter(args[earthquakeIndex]);
    }
