...
// static bool
// test_change_cmdline(char** cmdline)
// {
//     char* ls_line = malloc(3 * sizeof(char));
//     strncpy(ls_line, "ls", 2);
//     ls_line[2] = '\0';
//     *cmdline = ls_line;
...
// static bool
// test_change_pipeline(struct esh_pipeline * pipe)
// {
//     pipe->bg_job = true;
...
//   .process_raw_cmdline = test_change_cmdline
//   .process_pipeline = test_change_pipeline
};
