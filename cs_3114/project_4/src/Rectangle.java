...
public class Rectangle
{
	 ...
	 * rectangle. The given rectangle will no be considered to be overlapping if
	 * the top or right edge are the only overlapping parts of the two
	 * rectangles.
	 *
	 * @param rec
	 ...
	 *
	 * @param r
	 *            The Rectangle from which to get the other two Rectangles.
	 * @param discriminator
	 ...
	 * @return A Rectangle the lies within r and is either the top/bottom half,
	 *         or left/right half.
	 */
	...
	/**
	 * Generates two Rectangle object the occupy the entire space of r, with the
	 * first Rectangle occupying the left half, and the second Rectangle
	...
	/**
	 * Generates two Rectangle object the occupy the entire space of r, with the
	 * first Rectangle occupying the bottom half, and the second Rectangle
	 * occupying the top half.
	 *
	 * @param r
	 *            The Rectangle to split.
	 * @return Two Rectangles, one occupying the bottom half, and the other the
	 *         top half of r.
	 */
