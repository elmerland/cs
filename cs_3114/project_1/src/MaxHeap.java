 ...
 * @version Sep 11, 2013
 */
public class MaxHeap<E extends ComparableIndexable<? super E>>
{
    ...
    /**
     * Determines if the given postion corresponds to a leaf.
     *
     * @param pos
    ...
    public void insert(E val)
    {
        ...
        while ((curr != 0) && (heap[curr].compareTo(heap[parent(curr)]) > 0))
        {
            ...
            // objects
            DSutil.swapIndexables(heap[curr].getIndexable(), heap[parent(curr)].getIndexable());
            /*
            EarthquakeManager.swapIndex(
                (EarthquakeManager.HeapLog)heap[curr],
                (EarthquakeManager.HeapLog)heap[parent(curr)]);*/
    ...
    private void siftdown(int pos)
    {
        ...
        while (!isLeaf(pos))
        {
            ...
            /*EarthquakeManager.swapIndex(
                (EarthquakeManager.HeapLog)heap[pos],
                (EarthquakeManager.HeapLog)heap[j]);*/
    ...
    public E removemax()
    {
        ...
        /*EarthquakeManager.swapIndex(
            (EarthquakeManager.HeapLog)heap[0],
            (EarthquakeManager.HeapLog)heap[temp]);*/
    ...
    public E remove(int pos)
    {
        ...
        else
        {
            ...
            // Swap the indexes of the QueueLog objects inside of the HeapLog
            // objects
            DSutil.swapIndexables(heap[pos].getIndexable(), heap[updatedN].getIndexable());
            /*EarthquakeManager.swapIndex(
                (EarthquakeManager.HeapLog)heap[pos],
                (EarthquakeManager.HeapLog)heap[updatedN]);*/
            ...
            while ((pos > 0) && (heap[pos].compareTo(heap[parent(pos)]) > 0))
            {
                ...
                // HeapLog objects
                DSutil.swapIndexables(heap[pos].getIndexable(), heap[parent(pos)].getIndexable());
                /*EarthquakeManager.swapIndex(
                    (EarthquakeManager.HeapLog)heap[pos],
                    (EarthquakeManager.HeapLog)heap[parent(pos)]);*/
