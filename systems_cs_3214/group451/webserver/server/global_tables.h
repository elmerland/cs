...
// Total number of mime types.
#define MIME_NUM 884

// Structure to store the key value pairs of method string and enumerator.
struct method_kv {
	char * m_str;
	enum method m_enum;
};

// A table that stores the string and enum representation of HTTP methods.
struct method_kv method_table[METHOD_NUM] = {
	{"OPTIONS", OPTIONS},
	{"GET", GET},
	{"HEAD", HEAD},
	{"POST", POST},
...
// Structue to store the key value pairs of file extension and mime type.
struct mime_kv {
	char * extension;
	char * type;
};
...
// Table of mime types.
struct mime_kv mime_table[MIME_NUM] = {
